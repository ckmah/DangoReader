...
public class LibraryPageFragment extends Fragment {
    ...
    private List<MangaEdenMangaListItem> convertUserLibraryManga(List<UserLibraryManga> m) {
        ...
        for (UserLibraryManga temp : m) {
            ...
            temp2.setImageUrl(temp.getImageURL());
            temp2.setStatus(temp.getStatus());
            temp2.setHits(temp.getHits());
            temp2.setLastChapterDate(temp.getLastChapterDate());
            temp2.setId(temp.getMangaEdenId());
            result.add(temp2);
        }
        return result;
    }
